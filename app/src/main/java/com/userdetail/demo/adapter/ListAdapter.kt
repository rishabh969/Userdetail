...
class ListAdapter : PagingDataAdapter<Data, ListAdapter.ViewHolder>(DataDifferntiator) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.textViewGender.text = getItem(position)?.gender
        holder.itemView.textViewEmail.text = getItem(position)?.email
        holder.itemView.textViewStatus.text = getItem(position)?.status
